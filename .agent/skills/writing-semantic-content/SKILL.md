...
3.  **Tone**: Professional, Objective, Analytical (No fluff).
...
**I. Intro**: Hook + Definition + Value Prop.
**II. Body**:
...
□ Is the word count sufficient (aiming for 2500+)?
  → If short, expand the "Body" or "Expansion" sections with more examples/nuance.
